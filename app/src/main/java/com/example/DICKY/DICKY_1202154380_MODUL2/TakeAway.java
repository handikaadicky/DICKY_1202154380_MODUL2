...
public class TakeAway extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //inisiasi TextInputLayout dengan menggunakan id
    ...
    public void pilihpesan(View view) {
       ...
       String catatan = d.getEditText().getText().toString();
        ...
        //kirim nama dan jumlah ke dalam intent agar bisa di get pada class yang di tuju
    ...
    //mengambil method dari TimePickerFragment untuk menampilkan yang sudah di pilih
